    ...
    <div className="min-h-screen flex items-center justify-center bg-romantic-dark px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-romantic-light">Create your account</h2>
          <p className="mt-2 text-sm text-romantic-muted">
            Already have an account?{' '}
            <Link to="/login" className="font-medium text-romantic-primary hover:text-romantic-accent">
              Sign in
            </Link>
          </p>
        </div>
